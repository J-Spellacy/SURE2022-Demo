# Copying an example piece of code with pymunk just to learn basics
...
def create_structure(space, width, height):
    ...
    rects = [
        ...
        [(750, height - 230), (340, 40), BROWN, 150]
    ]
...
def run(window, width, height):
    ...
    #ball = create_ball(space, 30, 1, (300, 100))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if not ball:
                    ...
                    ball.body.apply_impulse_at_local_point((fx, fy), (0, 100))
                    pressed_pos = None
                else:
